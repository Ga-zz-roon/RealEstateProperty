...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td>From Date:</td>
      <td><label></label>      <span id="sprytextfield1">
        <label>
        <input type="text" name="txtFrom" id="txtFrom" onclick="ds_sh(this);" />
        </label>
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
      <td>To Date:</td>
      <td><span id="sprytextfield2">
        <label>
        <input type="text" name="txtTo" id="txtTo" onclick="ds_sh(this);" />
        </label>
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
      <td></td>
      <td></td>
...
$sql = "select * from news_master where NewsDate between '".$from."' and '".$to."'";
// Execute query
