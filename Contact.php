  ...
  <div class="content">
    <div class="innercontent">
      ...
      <table width="100%" height="249" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="27"><span class="style8">Sakarya-turkey</span></td>
        </tr>
        <tr>
          <td height="30"><span class="style8">Mobile:+905078506740</span></td>
        </tr>
        <tr>
          <td height="29"><span class="style8">Email:taha.garoon@gmail.com</span></td>
        </tr>
        <tr>
